    ...
    return (
        <section className="relative pb-24 pt-0 -mt-8 overflow-hidden z-20">
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                <div className="flex justify-center items-center h-[250px] sm:h-[300px] md:h-[400px]">
                    <div className="relative w-[300px] h-[400px] scale-[0.5] sm:scale-[0.6] md:scale-100">
                        {/* Left Card - Rabbit */}
                        <motion.div
